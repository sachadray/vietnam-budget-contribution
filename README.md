...
The page also carries the full VNTAX 200 for both list years as a searchable table (231 enterprises, English and Vietnamese names, dong and dollars), and the full STATE 100 for 2025.
...
| `data/VNTAX_2025_ownership_sector.xlsx` | Nine-sheet workbook with live formulas: firm-level tables, ownership and sector cuts, group structure, tax composition, year-on-year. |

## Read the list years carefully

**CafeF labels each list by its publication year, not the year of the payments.** The lists published in 2026 measure amounts actually remitted in financial year 2025. A list labelled 2025 is 2024 data.
...
Against total 2025 budget revenue of ₫2,650.1tn, the whole list is **37.3%** of revenue and the 74 state firms alone are **16.8%**.
...
- National budget outturn: General Statistics Office / Ministry of Finance, 2025 revenue = ₫2,650.1tn
...
**Balanced panel and the decomposition.** The published lists are re-cut every year, so a change in the state share mixes two things: the firms changing and the list changing. Matching 2024 to 2025 on ticker gives 169 enterprises present in both years — the match is unambiguous, since ticker and trading name agree exactly, with no duplicates and no renames. No enterprise changed ownership classification between the two years.

```
Basis                          n     2024   2025   change
...
**Years.** A year means a **financial year, running January to December** — Vietnam's financial year is the calendar year, so "2025" is 1 January to 31 December 2025. Years are written plainly as 2024 and 2025, with no FY prefix.
